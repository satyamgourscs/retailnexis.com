                                                    ...
                                                    <tbody>
                                                        @foreach ($lims_product_return_data as $key => $product_return)
                                                            <tr>
                                                                ...
                                                                $unit = DB::table('units')->where('id', $lims_product_sale_data[$key]->sale_unit_id)->first();
                                                                ...
                                                                <td>
                                                                    <input type="text" name="actual_qty[]"
                                                                        ...
                                                                        data-actual_qty="{{ $lims_product_sale_data[$key]->qty ?? 0 }}"
                                                                        value="{{ $lims_product_sale_data[$key]->qty ?? '' }}">
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td class="discount"
                                                                    data-unit_discount="{{ $lims_product_sale_data[$key]->discount / $lims_product_sale_data[$key]->qty }}">

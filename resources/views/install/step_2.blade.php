    ...
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                <br/><?php echo $ltext; ?><br/>Sorry. The requirements of SalePro are not available on your server. Share this code with your hosting provider or system administrator: <?php echo $passed; ?><br><br>

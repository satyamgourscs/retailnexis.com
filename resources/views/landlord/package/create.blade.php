            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' => route('packages.store', [], false), 'method' => 'post', 'id' => 'package-form']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-2 mt-4">
                                    <input type="checkbox" id="is_free_trial" name="is_free_trial" value="1" checked>
                                    <label>{{__('db.Free Trial')}}</label>
                                </div>
                                <div class="col-md-3 form-group">
                                	<label>{{__('db.Monthly Fee')}} *</label>
                                    <input type="number" id="monthly_fee" name="monthly_fee" required class="form-control">
                                </div>
                                <div class="col-md-2 form-group">
                                	<label>{{__('db.Yearly Fee')}} *</label>
                                    <input type="number" id="yearly_fee" name="yearly_fee" required class="form-control">
                                </div>
                                <div class="col-md-3 form-group">
